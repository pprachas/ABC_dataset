...
This code converts the [json files](https://open.bu.edu/handle/2144/43730) obtaimed from the dataset into networkx graphs. The obtained graphs can be used in the next section (ML).
